...
Table~\ref{tab:main_results} summarizes the main Monte Carlo results for three-victim scenarios. Under the tested simulation protocol where victims are randomly distributed, we observe that the distance router baseline achieves the lowest mean TTR ($10.31 \pm 2.64$ steps) but suffers from the worst safety outcomes, with a worst-case victim survival rate (Worst VSR) of $0.37 \pm 0.18$ and a catastrophic failure rate (CFR) of $0.48$. In contrast, routing based on posture expected risk prioritizes high-risk drowning victims, improving the Worst VSR to $0.40 \pm 0.19$ for \aes{} full and $0.40 \pm 0.18$ for deterministic expected risk, while reducing the CFR to $0.41$ and $0.38$, respectively.
...
\midrule
\aes{} full                    & \textbf{$0.40\pm0.19$} & $0.63\pm0.10$ & $11.48\pm2.84$ & \textbf{0.41} & \textbf{$0.52 \pm 0.44$} \\
No active branch               & $0.43\pm0.18$ & $0.63\pm0.12$ & $11.02\pm3.33$ & 0.35 & n/a \\
Static measurement covariance  & $0.40\pm0.17$ & $0.61\pm0.12$ & $11.86\pm3.33$ & 0.38 & $0.55 \pm 0.45$ \\
Deterministic expected risk    & $0.40\pm0.18$ & \textbf{$0.61\pm0.13$} & $12.00\pm3.96$ & 0.38 & n/a \\
Distance router                & $0.37\pm0.18$ & $0.64\pm0.10$ & $10.31\pm2.64$ & 0.48 & n/a \\
\bottomrule
\end{tabularx}
\end{table}

When active verification is enabled (\aes{} full), the UAV triggers an average of $0.8$ lower-altitude verification passes to resolve posture uncertainty under wave occlusion. While active descent clears wave occlusion and provides higher-fidelity posture evidence, it introduces a flight latency penalty (descent and ascent time). In a small 3-victim scenario without clutter, this latency penalty increases the mean TTR slightly from $11.02 \pm 3.33$ steps (No active branch) to $11.48 \pm 2.84$ steps, which offsets the local safety gain, resulting in a Worst VSR of $0.40 \pm 0.19$ and a CFR of $0.41$ compared to $0.43 \pm 0.18$ and $0.35$ for the no-branch ablation. This trade-off highlights that active verification is not a free operation; its benefits in resolving posture uncertainty must be balanced against the flight time penalty, which is especially critical in time-sensitive search and rescue missions.

Table~\ref{tab:robustness} evaluates the robustness of the routing policies under more challenging conditions: a high wave occlusion rate ($70\%$) and high victim density ($N=10$). Under $70\%$ initial occlusion, the Worst VSR for the full \aes{} system is $0.42 \pm 0.17$ with a CFR of $0.33$, compared to $0.44 \pm 0.17$ and a CFR of $0.29$ for the deterministic expected risk baseline. With $N=10$ victims, both methods experience high resource congestion, with Worst VSR dropping to $0.10 \pm 0.10$ (\aes{} full) and $0.13 \pm 0.11$ (Deterministic expected risk) due to the limited speed and flight horizon of a single UAV.
...
\midrule
70\% initial occlusion & \aes{} full & $0.42\pm0.17$ & 0.33 \\
70\% initial occlusion & Deterministic expected risk & $0.44\pm0.17$ & 0.29 \\
\midrule
$N=10$ victims & \aes{} full & $0.10\pm0.10$ & 0.96 \\
$N=10$ victims & Deterministic expected risk & $0.13\pm0.11$ & 0.94 \\
\bottomrule
\end{tabularx}
\end{table}
